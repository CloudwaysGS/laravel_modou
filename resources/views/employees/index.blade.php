                ...
                <div class="breadcomb-list">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <div class="breadcomb-wp">
                                ...
                                <div class="breadcomb-ctn">
                                    <h2>Tableau de données des Employées</h2>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-3" style="display: flex; align-items: center;">
                            ...
                            <div class="breadcomb-report">
                                <a href="{{ route('employees.create') }}"><button data-toggle="tooltip" data-placement="left" class="btn">Ajouter un Employé</button></a>
                            </div>
                        </div>
                    ...
                    <div class="table-responsive">
                        <table id="data-table-basic" class="table table-striped">
                            ...
                            <tr>
                                ...
                                <td>{{ $employee->avance }}</td>
                                <td>
                                    <a href="{{ route('employees.edit', $employee) }}">Modifier</a>
                                    <a href="{{ route('employees.show', $employee) }}">Paiement</a>
                                    <form action="{{ route('employees.destroy', $employee) }}" method="POST">
                                        @csrf @method('DELETE')
                                        <a><button type="submit">Supprimer</button></a>
                                    </form> 
                                </td>
                            </tr>
                            @endforeach
