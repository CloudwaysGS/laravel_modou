                ...
                <div class="breadcomb-list">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <div class="breadcomb-wp">
                                ...
                                <div class="breadcomb-ctn">
                                    <h2>Tableau de données des Salaires</h2>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-3" style="display: flex; align-items: center;">
                            ...
                            <div class="breadcomb-report">
                                <a href="{{ route('salaries.create') }}"><button data-toggle="tooltip" data-placement="left" class="btn">Ajouter une Avance</button></a>
                            </div>
                        </div>
                        ...
                        <table id="data-table-basic" class="table table-striped">
                            ...
                            <tr>
                                ...
                                <!--<td>
                                    ...
                                    <a href="{{ route('salaries.edit', $salaries) }}">Modifier</a>
                                    <a href="{{ route('salaries.show', $salaries) }}">Paiement</a>
