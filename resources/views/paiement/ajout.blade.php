...
<form action="{{ url('/paiement/ajout') }}" method="post">
    @csrf
    <div class="row">
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                                <div class="nk-int-st">
                                    <input type="text" name="id" value="{{ $paiement->id }}" class="form-control input-sm" readonly>
                                </div>
                                @error('id')
                ...
                <div class="form-example-int form-horizental mg-t-15">
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                                <div class="nk-int-st">
                                    <input type="text" name="client" value="{{ $paiement->client->nom }}" class="form-control input-sm" readonly>
                                </div>
                                @error('montant')
                                <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                ...
                <div class="form-example-int form-horizental mg-t-15">
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                                <div class="nk-int-st">
                                    <input type="text" name="reste" value="{{ $paiement->reste }}" class="form-control input-sm"  readonly>
                                </div>
                                @error('montant')
                                <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
