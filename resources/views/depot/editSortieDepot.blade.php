<base href="/public">
@include('header')
<form action="{{ route('depotSortie.update', $depot->id) }}" method="post">
    @csrf
    @method('PUT')
    <div class="row">
                ...
                <div class="form-example-int form-horizental mg-t-15">
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                                <div class="nk-int-st">
                                    <input type="number" name="qteSortie" value="{{ old('qteSortie', $depot->qteSortie) }}" class="form-control input-sm" >
                                </div>
                                @error('qteSortie')
                                <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
