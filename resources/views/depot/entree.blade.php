                ...
                <div class="breadcomb-list">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <div class="breadcomb-wp">
                                ...
                                <div class="breadcomb-ctn">
                                    <h2>Tableau de données Entrée dépôt</h2>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-3" style="display: flex; align-items: center;">
                            ...
                            <div class="breadcomb-report">
                                <a href="{{ route('depotEntree.create') }}"><button data-toggle="tooltip" data-placement="left" class="btn">Ajouter un produit</button></a>
                            </div>
                        </div>
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="data-table-list">
                    <form method="GET" action="{{ url('/depotEntree') }}" id="search-form">
                        @include('search')
                    </form>
                                        ...
                                        <div class="d-flex justify-content-center align-items-center">
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                                    <li>
                                                        <a class="dropdown-item" href="{{ route('depotEntree.confirmDestroy', $item->id) }} }}">supprimer</a>
                                                    </li>
                                                    <li><a class="dropdown-item" href="{{ route('depotEntree.edit', $item->id) }}">modifier</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </td>
